    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent intent) {
        ...
        if (intent != null) {
            if (requestCode == REQUEST_CODE_CUSTOMER) {
                ...
                if (message != null) {
                    Toast toast = Toast.makeText(getBaseContext(), "고객 관리, result code : " + resultCode + ", message : " + message, Toast.LENGTH_LONG);
                    toast.show();
                }
                ...
                if (message != null) {
                    Toast toast = Toast.makeText(getBaseContext(), "매출 관리, result code : " + resultCode + ", message : " + message, Toast.LENGTH_LONG);
                    toast.show();
                }
                ...
                if (message != null) {
                    Toast toast = Toast.makeText(getBaseContext(), "상품 관리, result code : " + resultCode + ", message : " + message, Toast.LENGTH_LONG);
                    toast.show();
                }
            }
        }
